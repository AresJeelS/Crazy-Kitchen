...
public class Player : MonoBehaviour, IKitchenObjectParent
{
    ...
    private void HandleInterections()
    {
        ...
        {
            _lastInteractorDirection = moveDirection;
        }
        float interactDistance = 2f;
        if (Physics.Raycast(transform.position, _lastInteractorDirection, out RaycastHit ray, interactDistance, countersLayerMask))
        {
            if (ray.transform.TryGetComponent(out BaseCounter baseCounter))
            {
